...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_CBPRINTF_REDUCED_INTEGRAL, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MODBUS_ROLE_SERVER, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MODBUS_SERVER, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MODBUS_RAW_ADU, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MODBUS_NUMOF_RAW_ADU, 1);
